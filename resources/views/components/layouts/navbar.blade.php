<div>
    <nav
        class="w-full sm:w-3/4 lg:w-1/2 max-w-xl p-1 mx-auto bg-white dark:bg-pink-700 dark:text-white top-0 shadow  flex items-center justify-end transition-all rounded ease-linear duration-300">
        {{-- *********************************************** --}}
