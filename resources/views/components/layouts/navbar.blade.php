<div>
    <nav
        class="w-full sm:w-3/4 lg:w-10/12 max-w-6xlxl p-1 mx-auto bg-white dark:bg-pink-700 dark:text-white top-0 shadow-sm shadow-gray-500 dark:shadow-pink-900 flex items-center justify-end transition-all rounded ease-linear duration-300">
        {{-- *********************************************** --}}
